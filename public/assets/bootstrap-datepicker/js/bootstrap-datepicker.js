...
!function ($) {
    ...
    var Datepicker = function (element, options) {
        ...
        if (this.isInline) {
            ...
            this.picker.addClass('datepicker-dropdown dropdown-menu p-2');
        }
        if (this.isRTL) {
            ...
            // เปลี่ยนจากไอคอนเดิมเป็น Font Awesome
            this.picker.find('.prev i').addClass('fas fa-arrow-right');
            this.picker.find('.next i').addClass('fas fa-arrow-left');
        }
