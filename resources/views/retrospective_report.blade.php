...
@section('content')
    ...
    <div class="container">
        ...
        <br>
            <div class="table-report" style="width: 100%; ">
                ...
                <tr>
                    ...
                    @if(Auth::user()->type == 1)  <th rowspan="2">สถานะการส่ง email</th>    @endif
...
{{--                                {{date('d/m/Y', strtotime($job->start_time))}}--}}
                            ...
                            @if(Auth::user()->type == 1) <td>{{$job->user? $job->user->name : ''}}</td>@endif
                            <td>
                                @if($job->status == "checked")
