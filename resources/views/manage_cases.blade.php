...
@section('content')
    ...
    <div class="container">
        ...
        @endif
        <h1 class="roboto" style="font-weight: 500">จัดการ Cases</h1>
            ...
            @if($cases->isNotEmpty())
                @foreach($cases as $case)
                    <tr>
                        ...
                        @if(\Illuminate\Support\Facades\Auth::user()->type == 1)
                            <td><a href="{{url("/update/case/{$case->id}")}}}"><button type="button" class="btn btn-outline-warning"><i class="mdi mdi-pencil icon"></i>แก้ไข</button></a></td>
                        @endif
                    </tr>
                @endforeach
