    ...
    <div class="container">
                ...
                <div class="row d-flex align-items-center mt-2">
                    <div class="col-4">
                        <div class="input-group input-daterange date align-items-center">
                            <input style="min-width: 150px" class="form-control m-0" name="start_date" type="date" max="{{$now}}" value="{{$start}}" >
                            <span class="input-group-text" id="inputGroup-sizing-sm">ถึง</span>
                            <input style="min-width: 150px" class="form-control " name="end_date" type="date" max="{{$now}}" value="{{$end}}" >
                        </div>
                    </div>
        ...
        <br>
            <div style="width: 100%;overflow:scroll ">
                ...
                <tr>
                    @if(Auth::user()->type == 1)
                    <th rowspan="2" style="width: 120px">ชื่อโรงพยาบาล</th>
                        @endif
                    <th rowspan="2" style="width: 80px" >start_date</th>
                    <th rowspan="2" style="width: 80px" >end_date</th>
                    <th rowspan="2" style="width: 60px">จำนวน</th>
                    <th colspan="6" style="width: 550px">ร้อยละความถูกต้องของแต่ละด้าน</th>
                    <th rowspan="2"  style="width: 100px">สถานะงาน</th>
                    <th rowspan="2"  style="width: 80px">สถานะการส่ง email</th>
                    <th rowspan="2"  style="width: 80px">วันทีประมวลผล</th>
                    <th rowspan="2" style="width: 80px">รายงาน</th>
                ...
                @if($jobs->isNotEmpty())
                    ...
                    @foreach($jobs as $job)
                        <tr>
                            ...
                            @endif
                            <td>
                                {{$job->start_date->addYear(543)->format('d-m-Y')}}</td>
