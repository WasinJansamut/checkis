        ...
        @else
            ...
            <form action="{{route('addReport')}}" method="post">
                ...
                @if(Auth::user()->type > 0)
                    <div class="row d-flex align-items-center">
                        <div class="col-12 col-sm-6 col-md-6">
                            ...
                            <select class="custom-select form-control select2" style="width: 300px;" tabindex="-1" aria-hidden="true" name="hosp" type="text" id="hosp-select">
                        ...
                        <div class="col-12 col-sm-6 col-md-6">
                            <select class="custom-select form-control" style="width: 200px;" name="area_code" id="area_code-select">
                ...
                <div class="row d-flex align-items-center">
                    ...
                    <div class="col-auto">
                        <input type="submit" value="ประมวลผล" class="btn btn-success" >
                    </div>
...
{{--                    <select class="custom-select form-control" style="width: 100px;float: left" name="month" type="text" required>--}}
...
{{--                    <select class="custom-select form-control" style="width: 100px;float: left"name="year" type="text" required>--}}
...
{{--            <a href="{{url("/checking")}}"><button type="button" class="btn btn-outline-success" style="margin-top: 20px">ตรวจงาน ทั้งหมด</button></a>--}}
...
{{--            @enderror--}}
            ...
            @if(Session::has('incomplete value'))
                <div class="alert alert-warning m-2" role="alert" style="width: 50%">
                    <span>เลือกข้อมูลอย่างน้อย 1</span>
                </div>F
            @endif

            @if(Session::has('no data'))
            <div class="alert alert-warning m-2" role="alert" style="width: 50%">
                <span>ไม่พบข้อมูล <strong>ของช่วงนี้</strong> ที่ต้องการค้นหา กรุณาเลือก <strong>ช่วง</strong> อีกครั้ง</span>
            </div>
            @endif
