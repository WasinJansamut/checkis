    ...
    <div id="app">
        ...
        <nav class="navbar navbar-expand-md navbar-light   shadow-sm" style="background-color: #006637;">
            <div class="container-fluid">
                <a class="navbar-brand mb-0 h1 roboto" style="color: #FFF;font-weight: 700;size: 18px"
                    href="{{ url('/') }}">
                    IS - CHECKING
                </a>
            ...
            <div class="d-flex" id="wrapper">
                <div class="border-end bg-white" id="sidebar-wrapper">
                    <div class="list-group list-group-flush">
                        <img style="width: 70px; height: 70px; display: block; margin: 5px auto"
                            src="{{ asset('storage/imgs/logo.svg') }}">
                        <a class="list-group-item list-group-item-action list-group-item-light p-3"
                            href="{{ url('/present/report') }}"><i class="mdi mdi-clipboard-text icon"></i>หน้าหลัก</a>
                        <a class="list-group-item list-group-item-action list-group-item-light p-3"
                            href="{{ url('/reorder') }}"><i class="mdi mdi-pencil-box icon"></i>สั่งตรวจใหม่</a>
                        <a class="list-group-item list-group-item-action list-group-item-light p-3"
                            href="{{ url('/retrospective/report') }}"><i class="mdi mdi-folder icon"></i>ผลการตรวจสอบ</a>
                        <a class="list-group-item list-group-item-action list-group-item-light p-3"
                            href="{{ url('/update/password', Auth::user()->id) }}"><i
                                class="mdi mdi-account icon"></i>แก้ไขข้อมูลส่วนตัว</a>

                        {{-- only super admin can manage users --}}
                        @if (Auth::user()->type == 1)
                            <a class="list-group-item list-group-item-action list-group-item-light p-3"
                                href="{{ url('/manage/users') }}"><i class="mdi mdi-account icon"></i>จัดการผู้ใช้งาน</a>
                            <a class="list-group-item list-group-item-action list-group-item-light p-3"
                                href="{{ url('/manage/hospitals') }}"><i
                                    class="mdi mdi-account icon"></i>จัดการโรงพยาบาล</a>
                            <a class="list-group-item list-group-item-action list-group-item-light p-3"
                                href="{{ url('/history') }}"><i class="mdi mdi-history icon"></i>ประวัติการใช้งาน</a>
                        @endif
                        <a class="list-group-item list-group-item-action list-group-item-light p-3"
                            href="{{ url('/manage/cases') }}"><i class="mdi mdi-check-all icon"></i>จัดการ case</a>
